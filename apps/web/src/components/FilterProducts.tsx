...
const FilterProducts = ({
  ...
  return (
    <div className="bg-primary-foreground p-4 rounded-lg w-64">
      ...
      <div id="filter-size" className="mb-4">
        <h3 id="filter-title-size" className="font-semibold mb-2">
          SIZE
        </h3>
        <div
            ...
            return (
              <div key={indx}>
                <button
                  ...
                  className={`w-full h-full ${size.get(key) ? 'bg-black text-white' : 'bg-white text-black '} p-2 rounded`}
                >
                  {key}
                </button>
              </div>
      ...
      <div id="filter-color" className="mb-4">
        <h3 id="filter-color-title" className="font-semibold mb-2">
          COLOR
        </h3>
      ...
      <div id="filter-category" className="mb-4">
        <h3 id="filter-category-title" className="font-semibold mb-2">
          CATEGORIES
        </h3>
      ...
      <div id="filter-price" className="mb-4">
        <h3 id="filter-price-title" className="font-semibold mb-2">
          PRICE
        </h3>
